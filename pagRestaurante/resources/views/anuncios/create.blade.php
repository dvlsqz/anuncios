...
@section('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::open(array('url'=>'anuncios/','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
			{{Form::token()}}
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<label for="precio">Precio</label>
							<input type="number" name="precio" required value="{{old('precio')}}" class="form-control" step="0.01" min="0">
					</div>
				</div>
