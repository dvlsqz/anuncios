    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./">Publicar Anuncios</a>
                <a class="navbar-brand hidden" href="./">PA</a>
            </div>

            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{url('anuncios/')}}"> <i class="menu-icon fa fa-dashboard"></i>Anuncios </a>
                    </li>
                      ...
                      <ul class="treeview-menu">
                        <li><a href="{{ route('logout') }}"
                            onclick="event.preventDefault();
                                     document.getElementById('logout-form').submit();"> <i class="menu-icon fa fa-sign-in"></i>
                            Cerrar Sesion
                        </a>
        ...
        <header id="header" class="header">
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-7">
                    ...
                    <span class="text-right">Sistema Restaurante</span>
